#!/usr/bin/env python3
"""
Working Framework Backtest

Fixed version that properly handles the first touch logic and bars data.
"""
...
def run_working_framework_backtest():
    """Run the working framework backtest with first-touch data."""
    
    print("🚀 WORKING FRAMEWORK BACKTEST - FIRST TOUCH DATA")
    print("=" * 70)
...
if __name__ == "__main__":
    run_working_framework_backtest()